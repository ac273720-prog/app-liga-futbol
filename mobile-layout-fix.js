...
@media(max-width:700px){
  ...
  .top h1{font-size:1rem!important;line-height:1.08!important;max-width:100%!important;word-break:normal!important}
  ...
  .top-choice{grid-column:1/-1!important;width:100%!important;display:grid!important;grid-template-columns:1fr!important;gap:5px!important}
  .top-choice select{width:100%!important;min-width:0!important;max-width:none!important}
  ...
  .filters label{min-width:0!important;width:100%!important}
  .filters select{width:100%!important}

  /* Tabla de serie: POS + EQUIPO + DG + PTS. La clasificación va bajo el nombre. */
  #pubStandings,#standings{font-size:.78rem!important}
  #pubStandings table,#standings table{min-width:0!important}
  #pubStandings tr>*:nth-child(3),#pubStandings tr>*:nth-child(4),#pubStandings tr>*:nth-child(5),#pubStandings tr>*:nth-child(6),#pubStandings tr>*:nth-child(7),#pubStandings tr>*:nth-child(8),
  #standings tr>*:nth-child(3),#standings tr>*:nth-child(4),#standings tr>*:nth-child(5),#standings tr>*:nth-child(6),#standings tr>*:nth-child(7),#standings tr>*:nth-child(8){display:none!important}
  #pubStandings td[data-qualification],#standings td[data-qualification]{display:none!important}
  #pubStandings td:nth-child(1),#standings td:nth-child(1){width:36px!important;min-width:36px!important;padding-left:7px!important;padding-right:5px!important}
  #pubStandings td:nth-child(2),#standings td:nth-child(2){width:auto!important;min-width:128px!important;text-align:left!important;padding-left:8px!important;padding-right:6px!important}
  #pubStandings td:nth-child(9),#standings td:nth-child(9){width:48px!important;min-width:48px!important;padding-left:5px!important;padding-right:5px!important}
  #pubStandings td:nth-child(10),#standings td:nth-child(10){width:52px!important;min-width:52px!important;padding-left:5px!important;padding-right:7px!important;font-size:.96rem!important;font-weight:950!important}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings:not(:empty),#standings:not(:empty){display:table-row-group!important}
  #pubStandings,#standings{white-space:normal!important}
  #pubStandings tr,#standings tr{height:auto!important}
  #pubStandings td,#standings td{padding-top:10px!important;padding-bottom:10px!important;vertical-align:middle!important}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings{width:100%!important}
  #standings{width:100%!important}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings td:nth-child(2)>b,#standings td:nth-child(2)>b{display:block}
  ...
  /* Encabezado de la tabla de serie: oculta las mismas columnas y Situación separada. */
  #pubStandings{--mobile-table:1}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings{contain:none}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings:not(:empty){visibility:visible!important}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings.closest-table-placeholder{display:none}
  ...
  /* Reglas reales para thead (selector por tabla contenedora). */
  #pubStandings{display:table-row-group}
  #standings{display:table-row-group}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings.closest-table-placeholder{display:none}
  #pubStandings.closest-table-placeholder{display:none}
  ...
  /* Tabla general sí conserva POS, Equipo, PTS y Situación. */
  ...
  #pubGeneralCard th,#pubGeneralCard td,#adminGeneralCard th,#adminGeneralCard td{padding:8px 5px!important;font-size:.72rem!important;white-space:normal!important;word-break:normal!important}
  ...
  #pubGeneralCard td[data-qualification] b,#adminGeneralCard td[data-qualification] b{min-width:0!important;width:auto!important;padding:4px 5px!important;font-size:.62rem!important;line-height:1.06!important}
...
function fixTable(body){
  ...
  if(table){table.classList.add('mobile-series-table');const head=table.querySelector('thead tr');if(head){[3,4,5,6,7,8].forEach(n=>head.children[n-1]?.classList.add('mobile-stat-hide'));head.querySelector('th[data-qualification]')?.classList.add('mobile-situation-hide')}}
...
finalCss.textContent=`@media(max-width:700px){
 ...
 .mobile-series-table th:nth-child(1){width:36px!important}.mobile-series-table th:nth-child(2){width:auto!important}.mobile-series-table th:nth-child(9){width:48px!important}.mobile-series-table th:nth-child(10){width:52px!important}
}`;
document.head.appendChild(finalCss);
function run(){fixTable($('#pubStandings'));fixTable($('#standings'))}
function init(){run();['pubStandings','standings'].forEach(id=>{const el=$('#'+id);if(el&&!el.dataset.mobileFix){el.dataset.mobileFix='1';new MutationObserver(()=>setTimeout(run,30)).observe(el,{childList:true,subtree:true})}});setInterval(run,700)}
